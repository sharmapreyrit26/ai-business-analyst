...
const presets = [
  {
    label: 'AOV +5%',
    question: 'What if AOV increases by 5%?',
  },
  {
    label: 'AOV +12%',
    question: 'What if AOV increases by 12%?',
  },
  {
    label: 'Recover 50% Orders',
    question: 'What happens if we recover half of lost orders?',
  },
  {
    label: 'Orders +5%',
    question: 'What happens if orders increase by 5%?',
  },
  {
    label: 'Orders +5%, AOV +5%',
    question: 'What if orders increase by 5% and AOV increases by 5%?',
  },
]
...
export default function Scenario({
  ...
  const [question, setQuestion] =
    useState('What if AOV increases by 12%?')
  ...
  const difference =
    scenarioResult?.difference ?? {}

  const assumptions =
    scenarioResult?.assumptions ?? {}

  const limitations =
    scenarioResult?.limitations ?? []

  const revenueImpact =
    difference.incremental_revenue
            ...
            <div className="scenario-comparison-grid">
              <div className="card">
                ...
                <div className="metric-list">
                  ...
                  {
                    current.aov !== undefined
                    && (
                      <div>
                        <span>AOV</span>
                        <strong>
                          {fmtMoney(current.aov)}
                        </strong>
                      </div>
                    )
                  }
              ...
              <div className="card scenario-result-card">
                ...
                <div className="metric-list">
                  {
                    simulated.revenue !== undefined
                    && (
                      <div>
                        <span>Revenue</span>
                        <strong>
                          {fmtMoney(simulated.revenue)}
                        </strong>
                      </div>
                    )
                  }
                  ...
                  {
                    simulated.orders !== undefined
                    && (
                      <div>
                        <span>Orders</span>
                        <strong>
                          {fmtNumber(simulated.orders)}
                        </strong>
                      </div>
                    )
                  }
                  ...
                  {
                    simulated.aov !== undefined
                    && (
                      <div>
                        <span>AOV</span>
                        <strong>
                          {fmtMoney(simulated.aov)}
                        </strong>
                      </div>
                    )
                  }
